            ...
            >
                {this.props.question === 0 || this.props.question === (this.props.questions.length) ?
                    ...
                    <Grid container spacing={2} className='h-100'>
                        ...
                        <Grid item xs={12}>
                            <span style={{color: 'white'}}>
                                <a href='https://www.w3schools.com/js/' target='_blank'>01. W3 Schools</a>
                            </span>
                        </Grid>
                        <Grid item xs={12}>
                            <span style={{color: 'white'}}>
                                <a href='https://developer.mozilla.org/en-US/docs/Web/JavaScript' target='_blank'>02. MDN Web Documents</a>
                            </span>
                        </Grid>
